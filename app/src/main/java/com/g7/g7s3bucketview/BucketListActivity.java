...
import static com.g7.g7s3bucketview.MainActivity.bucketName;

/**
 * Created by newagesmb on 20/4/18.
 */
...
public class BucketListActivity extends ListActivity {
    ...
    private void initData() {
        ...
        s3 = Util.getS3Client(BucketListActivity.this);
...
//        });
    ...
    private class GetFileListTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            dialog = ProgressDialog.show(BucketListActivity.this, "Refreshing", "Please Wait");
        }

        @Override
        protected Void doInBackground(Void... inputs) {
            // Queries files in the bucket from S3.
            s3ObjList = s3.listObjects(bucketName).getObjectSummaries();
